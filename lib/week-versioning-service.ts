...
import { doc, serverTimestamp, setDoc, getDoc, runTransaction, Firestore } from "firebase/firestore"
import { db, COLLECTIONS } from "@/lib/firebase"
import { ShiftAssignment, Empleado } from "@/lib/types"

// Agregar colección WEEKS a COLLECTIONS
...
export class WeekVersioningService {
  ...
  static async completeCurrentWeek(
    ...
    try {
      const weekRef = doc(db, COLLECTIONS.WEEKS, baseWeekId)
