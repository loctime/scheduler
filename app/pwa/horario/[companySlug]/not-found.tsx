...
/**
 * Página 404 controlada para rutas públicas de companySlug
 * 
 * Características:
 ...
 */
export default function PublicHorarioNotFound() {
  const router = useRouter()

  useEffect(() => {
    // Log del intento de acceso para seguridad
    console.log(`🔍 [Public404] Acceso a horario no encontrado: ${window.location.pathname}`)
    
    // En producción, esto podría ir a una colección de logs
    if (typeof window !== 'undefined' && (window as any).gtag) {
      (window as any).gtag('event', 'page_not_found', {
        page_title: 'Public Horario Not Found',
          ...
          <div className="text-center space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-600">
                El horario que buscas no está disponible o el enlace es incorrecto.
              </p>
            </div>
            ...
            <div className="text-left bg-gray-50 rounded-lg p-3 space-y-2">
              ...
              <ul className="text-xs text-gray-600 space-y-1 ml-4">
                ...
                <li>• El horario fue desactivado</li>
