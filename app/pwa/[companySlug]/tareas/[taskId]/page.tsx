...
export default function TareaDetallePage() {
  ...
  // Validar restricción: empleado no puede editar tareas del admin
  if (task.source !== "employee" && viewer?.employeeId) {
    return (
      <div className="min-h-screen bg-gray-50 p-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <div className="flex items-center space-x-2 text-yellow-800">
              <span className="text-lg font-semibold">Acceso Restringido</span>
              <span className="text-yellow-600">Solo puedes ver tareas creadas por empleados.</span>
            </div>
            <Button
              variant="outline"
              onClick={() => router.back()}
